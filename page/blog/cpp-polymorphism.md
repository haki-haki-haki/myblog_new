...
template<typename T>
void Myarry<T>::set(int i,T value)
{
    if(i>=0 && i < size)
    {
        arry[i] = value;
...
<span class="sk-ann red">不允许重载的运算符号 `. .* :: ?:`</span>
...
<span class="sk-ann orange">操作数个数 = 原来的操作数个数</span>
